...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_('Phone Number'), max_length=30, default='+123123123')
    about_me = models.TextField(verbose_name=_('About me'), default='say something about yourself')
    license = models.CharField(verbose_name=_('Real Estate license'), max_length=20, blank=True, null=True, default='/profile_default.jpg')
