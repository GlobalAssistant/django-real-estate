# Generated by Django 3.2.7 on 2022-05-27 16:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_code', models.CharField(default='140', max_length=100, verbose_name='Postal Code')),
                ...
                ('tax', models.DecimalField(decimal_places=2, default=0.15, help_text='15% property tax charged', max_digits=4, verbose_name='Property Tax')),
                ('plot_area', models.DecimalField(decimal_places=2, default=0.0, max_digits=8, verbose_name='Plot Area(m^2')),
                ('total_floors', models.IntegerField(default=0, verbose_name='Numbr of floors')),
