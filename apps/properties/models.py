...
class Property(TimeStampedUUIDModel):
    ...
    post_code = models.CharField(verbose_name=_('Postal Code'), max_length=100, default='140')
    ...
    tax = models.DecimalField(verbose_name=_('Property Tax'), max_digits=4, decimal_places=2, default=0.15, help_text='15% property tax charged')
    plot_area = models.DecimalField(verbose_name=_('Plot Area(m^2'), max_digits=8, decimal_places=2, default=0.0)
    total_floors = models.IntegerField(verbose_name=_('Numbr of floors'), default=0)
    ...
    def save(self, *args, **kwargs):
        ...
        self.ref_code = ''.join(random.random.choices(string.string.ascii_uppercase + string.digits, k=10)
        )
...
class PropertyViews(TimeStampedUUIDModel):
    ...
    class Meta:
        ...
        verbose_name_plural = 'Total Property Value'
