...
# SECRET_KEY = 'django-insecure-%^p_o$3wj=w@-zfl8o-&f(m$0h913njgk5vw!#9s=lyoj)&@a0'
...
SIMPLE_JWT = {
    ...
    'AUTH_HEADER_NAME': 'HTTP_AUTHORIZATINO',
...
DJOSER = {
    ...
    'USERNAME_RESET_COFRIM_URL': 'email/reset/confirm/{uid}/{token}',
    'ACTIVATION_URL': 'activate/{uid}/{token}',
    'SEND_ACTIVATION': True,
    'SERIALIZERS': {
        'user_create': 'apps.users.serializers.CreateUserSerializer',
        'user': 'apps.users.serializers.UserSerializer',
        'current_user': 'apps.users.serializers.UserDeleteSerializer',
    }
}
